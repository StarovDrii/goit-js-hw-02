...
function getShippingMessage(country, price, deliveryFee) {
    ...
    if (country === "Ukraine") {
        return `Shipping to Ukraine is free. 150 credits - total cost you order`;
    }
    return `Shipping to ${country} will cost ${totalPrice} credits`;
}

// console.log(getShippingMessage("Ukraine", 150, 0)); // "Shipping to Ukraine is free. 150 credits - total cost you order"
